    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            switch(tabControl1.SelectedIndex)
            {
                ...
                case 4:
                    {
                        short[] regs = new short[100];
                        modbus.ReadRegisters(1, 1000, 13, ref regs); //tdc1000 config regs are at address 1000
                        ...
                        numericTOF0.Value = (byte)(regs[2] / 256);
                        ...
                        checkBoxPgaCtrl.Checked = (temp & 0x10) == 0x10;
                        checkBoxLnaCtrl.Checked = (temp & 0x08) == 0x08;
                        ...
                        checkBoxForceShortTOF.Checked = (temp & 0x80) == 0x80;
                        checkBoxEchoTimeout.Checked = (temp & 0x02) == 0x02;
                        switch (temp & 0x03)
                        {
                            case 0:
                                comboBoxTofTimeoutCtrl.Text = "8 ×T0";
                                break;
                            case 1:
                                comboBoxTofTimeoutCtrl.Text = "16 ×T0";
                                break;
                            case 2:
                                comboBoxTofTimeoutCtrl.Text = "32 ×T0";
                                break;
                            case 3:
                                comboBoxTofTimeoutCtrl.Text = "64 ×T0";
                                break;
                        }
                        switch ((temp >> 3) & 0x07)
                        {
                            case 0:
                                comboBoxShortTOFBlankPeriod.Text = "8 ×T0";
                                break;
                            case 1:
                                comboBoxShortTOFBlankPeriod.Text = "16 ×T0";
                                break;
                            case 2:
                                comboBoxShortTOFBlankPeriod.Text = "32 ×T0";
                                break;
                            case 3:
                                comboBoxShortTOFBlankPeriod.Text = "64 ×T0";
                                break;
                            case 4:
                                comboBoxShortTOFBlankPeriod.Text = "128 ×T0";
                                break;
                            case 5:
                                comboBoxShortTOFBlankPeriod.Text = "256 ×T0";
                                break;
                            case 6:
                                comboBoxShortTOFBlankPeriod.Text = "512 ×T0";
                                break;
                            case 7:
                                comboBoxShortTOFBlankPeriod.Text = "1024 ×T0";
                                break;
                        }
                        #endregion
                        ...
                        {
                            case 0:
                                comboBoxAutozeroPeriod.Text = "64 ×T0";
                                break;
                            case 1:
                                comboBoxAutozeroPeriod.Text = "128 ×T0";
                                break;
                            case 2:
                                comboBoxAutozeroPeriod.Text = "256 ×T0";
                                break;
                            case 3:
                                comboBoxAutozeroPeriod.Text = "512 ×T0";
                                break;
                        }
